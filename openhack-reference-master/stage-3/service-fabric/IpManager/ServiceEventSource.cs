...
namespace IpManager
{
    [EventSource(Name = "MyCompany-TenantManagerApp-IpManager")]
    internal sealed class ServiceEventSource : EventSource
    {
        ...
        [Event(ServiceTypeRegisteredEventId, Level = EventLevel.LogAlways, Message = "Service host process {0} registered service type {1}", Keywords = Keywords.ServiceInitialization)]
        ...
        [Event(ServiceRequestStartEventId, Level = EventLevel.LogAlways, Message = "Service request '{0}' started", Keywords = Keywords.Requests)]
        ...
        [Event(ServiceRequestStopEventId, Level = EventLevel.LogAlways, Message = "Service request '{0}' finished", Keywords = Keywords.Requests)]
